...
def generateScenario(BleTable):
    template.stream(BleTable=BleTable, fileToParse='/home/pi/mirage/mirage/tables/scenario/ble_tables.txt',
                    properRules=BleTable.groupCommandRules()).dump("/home/pi/mirage/mirage/scenarios/mitm_test.py")
